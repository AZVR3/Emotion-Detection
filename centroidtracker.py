...
# define a class to track objects using centroids
class CentroidTracker():
    ...
    def update(self, rects):
        ...
        # try to match the input centroids to existing object IDs
        else:
            ...
            # and then (2) sort the row indexes based on their minimum values so that the row
            ...
            # in order to determine if we need to update, register, or deregister an object we need
            # to keep track of which of the rows and column indexes we have already examined
